...
async def stream_start(client, message):
    ...
    await log_msg.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🚀 Fast Download 🚀", url=download_url),
    ...
    await message.reply_text(text=msg_text.format(get_name(log_msg), humanbytes(get_media_file_size(message)), download_url, stream_url), quote=True, disable_web_page_preview=True, reply_markup=rm)